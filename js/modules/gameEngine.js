...
function startGame() {
    ...
    // create new snake
    var x = (snakeLength + 2) * Helper.ObjectSize.WIDTH;
...
function afterEndGameEvents() {
    ...
    gameField.context.clearRect(0, 0, Helper.FieldSize.WIDTH, Helper.FieldSize.HEIGHT);
    gameField.context.font = fontSize + "px Arial";
    gameField.context.textAlign = 'center';
    gameField.context.fillStyle = "green";
    gameField.context.fillText("Game Over", Helper.FieldSize.WIDTH / 2, Helper.FieldSize.HEIGHT / 2);
}
