...
export default class Snake extends GameObject {
    ...
    update() {
        ...
        switch (this.direction) {
            ...
            case Helper.Directions.UP:
                ...
                break;
            default:
                throw new Error('Please, use only Right, Left, Down, Up directions');
        }
    ...
    //(maybe it could be made public so the snake could be controlled from outside the engine)
